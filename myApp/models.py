...
class Question(models.Model):
	...
	QUESTION_TYPES = (
		(TEXT, _(u'คำตอบยาว')),
		(SHORT_TEXT, _(u'คำตอบสั้น')),
	)

	text = models.CharField( max_length=600)
	required = models.BooleanField(_("Required"),)
	survey = models.ForeignKey(Survey, verbose_name=_("Survey"),related_name="questions",on_delete=models.PROTECT)
...
class Response(models.Model):
    ...
    survey = models.ForeignKey(Survey, verbose_name=_("Survey"),
                               related_name="responses",on_delete=models.PROTECT)
