...
class Question(models.Model):
    ...
    QUESTION_TYPES = (
        (TEXT, _(u'text (คำตอบยาว)')),
        (SHORT_TEXT, _(u'short text (คำตอบสั้น)')),
        (RADIO, _(u'choices (คำตอบแบบสเกล)')),
    )

    text = models.TextField(_("Text"))
    required = models.BooleanField(_("Required"),)
    survey = models.ForeignKey(Survey, verbose_name=_("Survey"),
                               related_name="questions",on_delete=models.PROTECT)
    ...
    def save(self, *args, **kwargs):
        if self.type in [Question.RADIO]:
...
class Response(models.Model):
    ...
    survey = models.ForeignKey(Survey, verbose_name=_("Survey"),related_name="responses",on_delete=models.PROTECT)
    user = models.ForeignKey(user_model, verbose_name=_("User"), null=True,blank=True,on_delete=models.PROTECT)					   
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(Question, verbose_name=_("Question"),
                                 related_name="answers",on_delete=models.PROTECT)
